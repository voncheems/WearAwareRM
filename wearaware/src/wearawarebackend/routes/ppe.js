...
router.post('/detect', requireAuth, requireRole('inspector', 'user'), limiter(60, 60 * 1000, { keyGenerator: req => String(req.user.id) }), upload.single('file'), async (req, res, next) => {
